...
void Rubber::GetBoundingVertices(eastl::vector<Vertex3Ds>& pvvertex3D)
{
...
void Rubber::GenerateVertexBuffer()
{
   ...
   if (dynamicVertexBuffer)
      dynamicVertexBuffer->release();
   VertexBuffer::CreateVertexBuffer(m_numVertices, m_d.m_staticRendering ? 0 : USAGE_DYNAMIC, MY_D3DFVF_NOTEX2_VERTEX, &dynamicVertexBuffer);
   ...
   dynamicIndexBuffer = IndexBuffer::CreateAndFillIndexBuffer(ringIndices);
}
