...
void WaveFrontObj_WriteFaceInfo(FILE *f, const eastl::vector<WORD> &faces);
void WaveFrontObj_WriteFaceInfoLong(FILE *f, const eastl::vector<unsigned int> &faces);
void WaveFrontObj_Save(const char *filename, const char *description, const Mesh& mesh);
void WaveFrontObj_GetVertices(eastl::vector<Vertex3D_NoTex2>& objMesh);
void WaveFrontObj_GetIndices(eastl::vector<unsigned int>& list);
