...
#define _STANDARD_DISPATCH_INDEPENDANT_EDITABLE_DECLARES(T, ItemType) \
   ...
   virtual HRESULT SaveData(IStream *pstm, HCRYPTHASH hcrypthash, BOOL backupForPlay); \
...
public:
   ...
   virtual HRESULT SaveData(IStream *pstm, HCRYPTHASH hcrypthash, BOOL bBackupForPlay) = 0;
