...
public:
   ...
   virtual void Polygon(const eastl::vector<RenderVertex> &rgv) = 0;
   virtual void PolygonImage(const eastl::vector<RenderVertex> &rgv, HBITMAP hbm, const float left, const float top, const float right, const float bottom, const int bitmapwidth, const int bitmapheight) = 0;
